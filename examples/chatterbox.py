...
def can_see(pos):
    block = bot.bot.blockAt(pos)
    canSee = bot.bot.canSeeBlock(block)
...
@lodestone.Event(bot, "playerJoined")
...
@lodestone.Event(bot, "playerLeft")
...
@lodestone.Event(bot, "playerCollect")
def playerCollect(this, collector, collected):
    if collector.type == "player" and collected.type == "object":
        ...
        item = lodestone.Item.fromNotch(raw_item)
...
@lodestone.Event(bot, "entitySpawn")
...
@lodestone.Event(bot, "entityHurt")
